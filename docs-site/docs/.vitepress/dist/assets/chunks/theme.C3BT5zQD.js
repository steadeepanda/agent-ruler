const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.CBuU58dM.js","assets/chunks/framework.UCBG75GM.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.CBuU58dM.js"), true ? __vite__mapDeps([0,1]) : void 0));
