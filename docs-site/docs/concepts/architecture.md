...
title: Architecture
---
# Agent Ruler v0.1.9-1 Architecture (Linux-first)
...
| Timing/side-channel attacks | Different threat category | Not addressed in v0.1.9-1 |
...
│  • Byte-size enforcement not wired in v0.1.9-1                │
└─────────────────────────────────────────────────────────────┘
```
...
- Supported v0.1.9-1 mediated verb: `install_packages` (`sudo apt install ...` / `sudo apt-get install ...`).
