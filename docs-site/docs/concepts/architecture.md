...
title: Architecture
---
# Agent Ruler v0.1.9 Architecture (Linux-first)
...
| Timing/side-channel attacks | Different threat category | Not addressed in v0.1.9 |
...
│  • Byte-size enforcement not wired in v0.1.9                │
└─────────────────────────────────────────────────────────────┘
```
...
- Supported v0.1.9 mediated verb: `install_packages` (`sudo apt install ...` / `sudo apt-get install ...`).
